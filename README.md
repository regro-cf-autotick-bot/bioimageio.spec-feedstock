...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/bioimageio.spec-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/bioimageio.spec-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add bioimageio.spec
# for installing globally
pixi global install bioimageio.spec
```
...
It is possible to list all of the versions of `bioimageio.spec` available on your platform:
...
```
pixi search bioimageio.spec --channel conda-forge
```
